...
// vitest globals for placeholder test
// @ts-ignore
...
// Placeholder to prevent Vitest from flagging as empty suite if mistakenly included.
// This will be removed once test include patterns exclude helpers directory.
describe?.('__helpers_placeholder__', () => {
  it?.('noop', () => {
